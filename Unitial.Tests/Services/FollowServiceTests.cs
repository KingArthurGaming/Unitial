...
namespace Unitial.Tests.Services
{
    public class FollowServiceTests
    {
        ...
        public async Task TestFollowServiceFollow()
        {
            ...
            followService.Follow(Guid.NewGuid().ToString(), Guid.NewGuid().ToString());
        ...
        public async Task TestFollowServiceUnfollow()
        {
            ...
            followService.Follow(Guid.NewGuid().ToString(), Guid.NewGuid().ToString());
            followService.Follow("123456", "987564");
            followService.Unfollow("123456", "987564");
        ...
        public async Task TestFollowServiceIsFollowCount()
        {
            ...
            followService.Follow("123456", Guid.NewGuid().ToString());
            followService.Follow("123456", Guid.NewGuid().ToString());
            followService.Follow("123456", Guid.NewGuid().ToString());
        ...
        public async Task TestFollowServiceIsFollowersCount()
        {
            ...
            followService.Follow(Guid.NewGuid().ToString(), "123456");
            followService.Follow(Guid.NewGuid().ToString(), "123456");
            followService.Follow(Guid.NewGuid().ToString(), "123456");
        ...
        public async Task TestFollowServiceIsGetFollowedIds()
        {
            ...
            followService.Follow("123456", "1");
            followService.Follow("123456", "2");
            followService.Follow("123456", "3");
